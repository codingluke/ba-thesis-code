...
def train(job_id, params):
    ...
    C = {
        ...
        'hidden_3' : int(params['hidden_3'][0]),
        'hidden_4' : int(params['hidden_4'][0]),
        'mini_batch_size': 500
    }
    ...
    net = Network([
        ...
        AutoencoderLayer(n_in=C['hidden_2'], n_hidden=C['hidden_3'], rnd=rnd,
          corruption_level=C['corruption_level']),
        AutoencoderLayer(n_in=C['hidden_3'], n_hidden=C['hidden_4'], rnd=rnd,
          corruption_level=C['corruption_level']),
        FullyConnectedLayer(n_in=C['hidden_4'], n_out=1, rnd=rnd)],
        C['mini_batch_size'])
